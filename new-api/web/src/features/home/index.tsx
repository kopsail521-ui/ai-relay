...
import { DEFAULT_SEO, SITE_ORIGIN } from '@/lib/seo'
import { useAuthStore } from '@/stores/auth-store'

import { CTA, Features, Hero, HowItWorks, Stats } from './components'
import { useHomePageContent } from './hooks'

/** Append ?lang= so sandboxed brand pages get the shell language even if postMessage races. */
...
export function Home() {
  ...
  useEffect(() => {
    ...
    const onMessage = (event: MessageEvent) => {
      ...
      // Brand pages ask the shell to re-push the active language after load.
