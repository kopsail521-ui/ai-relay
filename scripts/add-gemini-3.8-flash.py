#!/usr/bin/env python3
"""Add OpenLux model gemini-3.8-flash into New API sqlite (channel + pricing + marketplace)."""
import json
import os
import sqlite3
import sys
...
OUR_MODEL_RATIO = 0.137869
OUR_COMPLETION_RATIO = 5
TAG = "大语言模型"
VENDOR = "Google"
ICON = "Gemini.Color"
ENDPOINTS = json.dumps({"openai": "/v1/chat/completions"}, separators=(",", ":"))
DESC = "Gemini 3.8 Flash · 更快更强的多模态轻量模型"
ABILITY_SRC = "gemini-3.7-flash"
        ...
        json.dumps(
            {
                "ok": True,
                "model": MODEL,
                "sell_in_usd": 0.275738,
                "sell_out_usd": 1.378688,
