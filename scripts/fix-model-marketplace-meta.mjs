...
const FIXES = {
  ...
  "gpt-image-2.5": { vendorName: "OpenAI", icon: "OpenAI", tag: "图片", endpoints: EP.image },
  ...
  "deepseek-v4-flash-0731": { vendorName: "DeepSeek", icon: "DeepSeek.Color", tag: "大语言模型", endpoints: EP.chat },
  "grok-4.6": { vendorName: "xAI", icon: "XAI", tag: "大语言模型", endpoints: EP.chat },
  "grok-4.7": { vendorName: "xAI", icon: "XAI", tag: "大语言模型", endpoints: EP.chat },
