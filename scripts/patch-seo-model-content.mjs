...
const EXPAND = {
  ...
  InfiniteTalk:
    "Image-to-talking-head starts with one portrait and one audio track. Upload the portrait directly as cond_video, the audio as cond_audio, and include prompt. Audio must be 15 seconds or shorter per job. Resolutions are 480P and 720P. For support bots, pre-render common answers and generate live only when needed.",
};
