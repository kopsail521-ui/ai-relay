...
Free (`*-free`): `kimi-k3-free` · `Atria-dawn-v2`

There is also a `:free` chat pool (for example `nemotron-3-ultra-550b-a55b:free`). The live list is https://www.keyoapi.xyz/free-models — the list changes over time.
